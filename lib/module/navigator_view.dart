...
import 'package:aplikasi_learning/module/splash_screens.dart';
import 'package:flutter/material.dart';
import 'package:google_fonts/google_fonts.dart';

class NavigatoerView extends StatefulWidget {
  const NavigatoerView({Key? key}) : super(key: key);

  @override
  State<NavigatoerView> createState() => _NavigatoerViewState();
}

class _NavigatoerViewState extends State<NavigatoerView> {
  int selectedIndex = 0;
  List menu = [
    {
      "title": "Home",
